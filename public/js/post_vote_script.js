...
{   
    ...
    {
        var _slice = null;
        //var _elem is used to find the votable_id and votable_type varibales
         var _elem = $(value);
        ...
        else if (_firstLetter === 'c')
        {
         ...
         //call the getvotes route and pass data. callback appends the vote count to the spam element
    ...
    $(".number-of-votes").on("votedOn",function( e, voteType, _Id, event )
        {
            ...
            $.post(_votedUpOrDownString, { whatIsWhatVotedOn: _whatIsVotedOn, itemId: _itemId}).done(
